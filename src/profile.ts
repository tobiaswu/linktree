...
export const profile: Profile = {
  ...
  introduction:
    "Hi there 👋 I'm an AI Strategist and Software Engineer. Contact me below 👇",
  ...
  links: [
    ...
    },
    {
      ...
      kind: 'instagram',
      label: 'Instagram',
      subtitle: 'See my photos on Instagram',
      url: 'https://instagram.com/tobiaswupp',
      order: 4,
    },
    {
      id: 'github',
